...
function BullDetailPage({ bullId, onBack }: BullDetailPageProps) {
  ...
  const bullsData: Record<string, BullData> = {
    ...
    "trovao-2b": {
      ...
      birthDate: "10 de Julio, 2014",
      lineage: "Sire: N/A | Dam: N/A",
      description:
        "TROVÃO 2B es un toro GYR probado con PTA Leite +721 (87% conf) y excelentes componentes lácteos. Genética A2A2 de calidad.",
      icc: {
        score: "N/A",
        pref: { value: "N/A", sust: "N/A", fert: "N/A" },
        nm: { value: "N/A", cm: "N/A", tpi: "N/A" },
      ...
      production: {
        milk: { value: "+721 (87% conf)", lbs: false, percent: "N/A" },
        protein: { value: "+15 Kg (+0.10%)", lbs: false, percent: "+0.10%" },
        fat: { value: "+31 Kg (+0.16%)", lbs: false, percent: "+0.16%" },
        feedSaved: { value: "N/A", percent: "" },
        rooota: "N/A",
      },
      healthTraits: [
        { name: "PTA Leite", value: "+721", interpretation: "Confiabilidad 87%" },
        { name: "Idade ao Primeiro Parto", value: "-140", interpretation: "Confiabilidad 82% - Alta precocidad" },
        { name: "NF (Número de Filhas)", value: "3", interpretation: "" },
        { name: "NR (Número de Rebaños)", value: "2", interpretation: "" },
        { name: "Gordura", value: "+31 Kg (+0.16%)", interpretation: "Confiabilidad 76%" },
        { name: "Proteína", value: "+15 Kg (+0.10%)", interpretation: "Confiabilidad 75%" },
        { name: "Sólidos Totais", value: "+35 Kg (+0.33%)", interpretation: "Confiabilidad 70%" },
        { name: "Producción Materna", value: "11,764 Kg en 365 días", interpretation: "" },
      ],
      sireFertility: [
        { name: "Confiabilidad PTA", value: "87%", reliability: "Alta" },
      ],
    ...
    "beneton-fiv-2b": {
      ...
      description:
        "BENETON FIV 2B es un toro GYR joven en prueba de progenie 2027. Madre con producción de 10,409 Kg en 365 días. Genética A2A2 BB AA.",
      icc: {
        score: "En progenie",
        pref: { value: "N/A", sust: "N/A", fert: "N/A" },
        nm: { value: "N/A", cm: "N/A", tpi: "N/A" },
    ...
    "elvis-da-estancia-k": {
      ...
      origin: "Brasil - Estancia K",
      birthDate: "29 de Noviembre, 2020",
      lineage: "Sire: N/A | Dam: N/A",
      description:
        "ELVIS DA ESTANCIA K es un toro GYR joven con genética A2A2 AB AA. Madre con producción de 10,401 Kg en 365 días.",
      icc: {
        score: "N/A",
        pref: { value: "N/A", sust: "N/A", fert: "N/A" },
        nm: { value: "N/A", cm: "N/A", tpi: "N/A" },
      ...
      healthTraits: [
        { name: "Producción Materna", value: "10,401 Kg en 365 días", interpretation: "Excelente producción" },
    ...
    "uno-2b": {
      ...
      origin: "Brasil - 2B Genetics",
      birthDate: "20 de Mayo, 2015",
      lineage: "Sire: N/A | Dam: N/A",
      description:
        "UNO 2B es un toro GYR con PTA Leite +857 (86% conf) y excelente producción de sólidos totais (+48 Kg). Genética A2A2 AA AA superior.",
      icc: {
        score: "N/A",
        pref: { value: "N/A", sust: "N/A", fert: "N/A" },
        nm: { value: "N/A", cm: "N/A", tpi: "N/A" },
      ...
      production: {
        milk: { value: "+857 (86% conf)", lbs: false, percent: "N/A" },
        protein: { value: "+22 Kg (0%)", lbs: false, percent: "0%" },
        fat: { value: "+42 Kg (+0.05%)", lbs: false, percent: "+0.05%" },
        feedSaved: { value: "N/A", percent: "" },
        rooota: "N/A",
      },
      healthTraits: [
        { name: "PTA Leite", value: "+857", interpretation: "Confiabilidad 86%" },
        { name: "Idade ao Primeiro Parto", value: "-89", interpretation: "Confiabilidad 81% - Alta precocidad" },
        { name: "NF (Número de Filhas)", value: "2", interpretation: "" },
        { name: "NR (Número de Rebaños)", value: "2", interpretation: "" },
        { name: "Gordura", value: "+42 Kg (+0.05%)", interpretation: "Confiabilidad 77%" },
        { name: "Proteína", value: "+22 Kg (0%)", interpretation: "Confiabilidad 75%" },
        { name: "Sólidos Totais", value: "+48 Kg (+0.09%)", interpretation: "Confiabilidad 68%" },
        { name: "Producción Materna", value: "9,355 Kg en 365 días", interpretation: "" },
      ],
      sireFertility: [
        { name: "Confiabilidad PTA", value: "86%", reliability: "Alta" },
      ],
      pedigree: {
        sire: "N/A",
        dam: "N/A",

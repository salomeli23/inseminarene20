...
function BullDetailPage({ bullId, onBack }: BullDetailPageProps) {
  ...
  const bullsData: Record<string, BullData> = {
    ...
    "krovis-tol": {
      ...
      dms: "En prueba",
      efi: "N/A",
      currentProof: "PNMGL-2026",
      imageUrl: "/GYR_KROVIS_TOL.jpg",
      origin: "Brasil - TOL Genetics",
      birthDate: "7 de Julio, 2016",
      lineage: "Sire: GENOMA TOL | Dam: HELGA FIV TOL",
      description:
        "KROVIS TOL es un toro GYR joven en prueba de progenie con genética superior A2A2 BB AA. Madre con producción de 13,068 Kg en 305 días.",
      icc: {
        score: "En progenie",
        pref: { value: "N/A", sust: "N/A", fert: "N/A" },
        nm: { value: "N/A", cm: "N/A", tpi: "N/A" },
      ...
      production: {
        milk: { value: "En progenie", lbs: false, percent: "N/A" },
      ...
      healthTraits: [
        { name: "Producción Materna", value: "13,068 Kg en 305 días", interpretation: "" },
        { name: "Genética", value: "A2A2 BB AA", interpretation: "Genética superior" },
        { name: "Estado", value: "En Prueba de Progenie - 2026", interpretation: "" },
      ],
      sireFertility: [
        { name: "Prueba de Progenie", value: "2026", reliability: "En curso" },
      ],
      pedigree: {
        sire: "GENOMA TOL (TOLA 430)",
        dam: "HELGA FIV TOL (TOLA 455)",
        mgs: "JAGUAR TE DO GAVIAO",
        mgd: "DALILA TE",
        mgss: "SOBERANO FIV BADAJOS",
        mgsd: "DINA TOL",
      },
    },
    "amarok-fiv-2b": {
      ...
      dms: "En prueba",
      efi: "N/A",
      currentProof: "PNMGL-2027",
      imageUrl: "/GYR_AMAROK_FIV_2B.jpg",
      origin: "Brasil - 2B Genetics",
      birthDate: "4 de Octubre, 2017",
      lineage: "Sire: JAGUAR TE DO GAVIÃO | Dam: TULIPA FIV 2B",
      description:
        "AMAROK FIV 2B es un GYR con genética A2A2 de alta calidad en prueba de progenie. Madre con producción de 10,444 Kg en 365 días.",
      icc: {
        score: "En progenie",
        pref: { value: "N/A", sust: "N/A", fert: "N/A" },
        nm: { value: "N/A", cm: "N/A", tpi: "N/A" },
      ...
      healthTraits: [
        { name: "Producción Materna", value: "10,444 Kg en 365 días", interpretation: "" },
        { name: "Genética", value: "A2A2 AB AA", interpretation: "Genética de calidad" },
        { name: "Estado", value: "En Prueba de Progenie - 2027", interpretation: "" },
      ],
      sireFertility: [
        { name: "Prueba de Progenie", value: "2027", reliability: "En curso" },
      ],
      pedigree: {
        sire: "JAGUAR TE DO GAVIÃO",
        dam: "TULIPA FIV 2B",
        mgs: "C.A.SANSÃO",
        mgd: "INCISÃO FIV DE BRAS.",
        mgss: "S.C.UACAI JAGUAR",
        mgsd: "UMIDADE",
      },
    },
    "tesouro-2b": {
      ...
      origin: "Brasil - 2B Genetics",
      birthDate: "28 de Noviembre, 2014",
      lineage: "Sire: NERO FIV 2B | Dam: PANDORA JHAZZA FIV 2B",
      description:
        "TESOURO 2B es un toro GYR probado con PTA Leite +427 y excelente producción de componentes lácteos. Genética A2A2 BB AA confiable.",
      icc: {
        score: "N/A",
        pref: { value: "N/A", sust: "N/A", fert: "N/A" },
        nm: { value: "N/A", cm: "N/A", tpi: "N/A" },
      ...
      production: {
        milk: { value: "+427", lbs: false, percent: "N/A" },
        protein: { value: "+8 Kg", lbs: false, percent: "-0.05%" },
        fat: { value: "+21 Kg", lbs: false, percent: "+0.03%" },
        feedSaved: { value: "N/A", percent: "" },
        rooota: "N/A",
      },
      healthTraits: [
        { name: "PTA Leite", value: "+427", interpretation: "Alta producción de leche" },
        { name: "Idade ao Primeiro Parto", value: "-73", interpretation: "Precocidad sexual" },
        { name: "NF (Número de Filhas)", value: "3", interpretation: "" },
        { name: "Gordura", value: "+21 Kg (+0.03%)", interpretation: "Buena producción de grasa" },
        { name: "Proteína", value: "+8 Kg (-0.05%)", interpretation: "" },
        { name: "Sólidos Totais", value: "+6 Kg (+0.15%)", interpretation: "Excelente contenido de sólidos" },
        { name: "Producción Materna", value: "6,513 Kg en 365 días", interpretation: "" },
      ],
      sireFertility: [
        { name: "PTA Valores", value: "Probados", reliability: "Confiable" },
      ],
      pedigree: {
        sire: "NERO FIV 2B",
        dam: "PANDORA JHAZZA FIV 2B",
        mgs: "ZAB 547",
        mgd: "JHAZZA TE 2B",
        mgss: "RADAR DOS POCOES",
        mgsd: "FADA TE DO GAVIAO",
      },
    },
    "jumbo-essencia": {
      id: "jumbo-essencia",
      ...
      origin: "Brasil - Essencia Genetics",
      birthDate: "10 de Junio, 2009",
      lineage: "Sire: SEPARATIVO TE DA CAL | Dam: JAVALANA TE DA PALMA",
      description:
        "JUMBO ESSENCIA es un GYR veterano con PTA Leite +258 y 82% de confiabilidad. Genética A2A2 AB AA confirmada con NF +11.",
      icc: {
        score: "N/A",
        pref: { value: "N/A", sust: "N/A", fert: "N/A" },
        nm: { value: "N/A", cm: "N/A", tpi: "N/A" },
      ...
      production: {
        milk: { value: "+258 (82% conf)", lbs: false, percent: "N/A" },
        protein: { value: "N/A", lbs: false, percent: "N/A" },
        fat: { value: "N/A", lbs: false, percent: "N/A" },
        feedSaved: { value: "N/A", percent: "" },
        rooota: "N/A",
      ...
      healthTraits: [
        { name: "PTA Leite", value: "+258", interpretation: "Confiabilidad 82%" },
        { name: "Idade ao Primeiro Parto", value: "-19", interpretation: "Confiabilidad 74%" },
        { name: "NF (Número de Filhas)", value: "+11", interpretation: "Alta cantidad de hijas evaluadas" },
        { name: "Producción Materna", value: "7,095 Kg en 365 días", interpretation: "" },
        { name: "Genética", value: "A2A2 AB AA", interpretation: "Genética confirmada" },
      ],
      sireFertility: [
        { name: "Confiabilidad PTA", value: "82%", reliability: "Alta" },
      ],
      pedigree: {
        sire: "SEPARATIVO TE DA CAL",
        dam: "JAVALANA TE DA PALMA",
        mgs: "BEM FEITOR RAPOSO",
        mgd: "HEMATIA ARAGUM CAL",
        mgss: "RADAR DOS POCOES",
        mgsd: "LOTERIA CAL",
      },
    },
    "beneton": {
      ...
      origin: "Brasil - Girolando",
      birthDate: "9 de Marzo, 2018",
      lineage: "Sire: PICASSO FIV 2B | Dam: INCISÃO FIV DE BRAS.",
      description:
        "BENETON es un toro GYR joven con alta producción materna (10,409 Kg en 365 días) y genética A2A2 BB AA de calidad superior.",
      icc: {
        score: "N/A",
        pref: { value: "N/A", sust: "N/A", fert: "N/A" },
        nm: { value: "N/A", cm: "N/A", tpi: "N/A" },
      ...
      production: {
        milk: { value: "Joven", lbs: false, percent: "N/A" },
        protein: { value: "N/A", lbs: false, percent: "N/A" },
        fat: { value: "N/A", lbs: false, percent: "N/A" },
        feedSaved: { value: "N/A", percent: "" },
        rooota: "N/A",
      ...
      healthTraits: [
        { name: "Producción Materna", value: "10,409 Kg en 365 días", interpretation: "Excelente producción" },
        { name: "Genética", value: "A2A2 BB AA", interpretation: "Genética superior confirmada" },
        { name: "Estado", value: "Toro Joven", interpretation: "En evaluación" },
      ],
      sireFertility: [
        { name: "Evaluación", value: "En curso", reliability: "Toro joven" },
      ],
      pedigree: {
        sire: "PICASSO FIV 2B (ZAB 542)",
        dam: "INCISÃO FIV DE BRAS. (RRP 6711)",
        mgs: "SUPRA-SUMO DE BRAS.",
        mgd: "BOSSA NOVA TE BRAS.",
        mgss: "JAGUAR TE DO GAVIÃO",
        mgsd: "DINA RADAR TE CAL",
      },
    },
  }

...
export default function Home() {
  ...
  const [currentPage, setCurrentPage] = useState<"home" | "holstein" | "jersey" | "pardo-suizo" | "ayrshire" | "gyr" | "girolando" | "girolando58" | "guzera">("home")
  const [currentSlide, setCurrentSlide] = useState(0)

  const heroImages = [
    "/hero-alabama-jbj.jpg",
    "/hero-trovao.jpg",
    "/hero-amarok-progenie.jpg"
  ]
  ...
  if (currentPage === "guzera") {
    return <GuzeraPage onBack={() => setCurrentPage("home")} />
  }
                    ...
                    <div className={`bg-gradient-to-br ${category.color} p-8 text-white relative overflow-hidden`}>
                      ...
                      {index === 1 && (
                        <>
                          <div 
                            className="absolute inset-0 bg-cover bg-center opacity-30"
                            style={{ backgroundImage: "url('/dairy-zebu-bg.jpg')" }}
                          ></div>
                          <div className="absolute inset-0 bg-gradient-to-br from-sky-600/80 to-blue-500/80"></div>
                        </>
                      )}
                      {index === 2 && (
                        <>
                          <div 
                            className="absolute inset-0 bg-cover bg-center opacity-30"
                            style={{ backgroundImage: "url('/beef-cattle-bg.jpg')" }}
                          ></div>
                          <div className="absolute inset-0 bg-gradient-to-br from-orange-600/80 to-red-500/80"></div>
                        </>
                      )}
